...
object Fixtures {
    ...
    fun newUniqueString(): String {
        ...
        return "${newAlphanumericString(lengthFrom = 8, lengthUntil = 16)}-$nanos-$counter"
    }
    ...
    fun newAlphanumericString(length: Int): String {
        return newAlphanumericString(lengthFrom = length, lengthUntil = length + 1)
    }
