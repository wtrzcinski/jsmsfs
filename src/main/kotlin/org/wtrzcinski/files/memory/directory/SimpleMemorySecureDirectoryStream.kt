...
import org.wtrzcinski.files.memory.spi.SimpleMemoryPath
import java.nio.channels.SeekableByteChannel
import java.nio.file.*
import java.nio.file.attribute.FileAttribute
import java.nio.file.attribute.FileAttributeView

internal class SimpleMemorySecureDirectoryStream(
    private val parent: SimpleMemoryPath,
    private val filter: DirectoryStream.Filter<in Path>,
    private val delegate: DirectoryStream<Path> = SimpleMemoryDirectoryStream(parent, filter),
