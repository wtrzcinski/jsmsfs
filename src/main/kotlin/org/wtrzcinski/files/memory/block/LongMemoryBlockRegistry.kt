...
import org.wtrzcinski.files.memory.byteBuffer.LongMemoryBlockByteBuffer
import org.wtrzcinski.files.memory.byteBuffer.MemoryBlockByteBuffer
import java.lang.foreign.MemorySegment

internal class LongMemoryBlockRegistry(
    ...
    override val bodySizeHeaderSize: Long = MemoryBlockRegistry.Companion.longByteSize

    override val nextRefHeaderSize: Long = MemoryBlockRegistry.Companion.longByteSize

    override fun buffer(offset: Long, size: Long): MemoryBlockByteBuffer {
        val asSlice: MemorySegment = memory.asSlice(offset, size)
        return LongMemoryBlockByteBuffer(memorySegment = asSlice)
    }
}